    ...
    <main className="p-3">
      ...
      <div className="flex flex-col md:flex-row  p-10 gap-8">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-center font-header p-8 ">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="font-header p-8 text-center">
