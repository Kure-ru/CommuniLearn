...
const Hero = () => {
    return (
      ...
      <div className="flex flex-col justify-center gap-12">
          ...
          <Link to="/login"><button className="font-header p-2 px-6   text-lg rounded-md  bg-gray-200">se connecter</button></Link>
          <Link to="/register"><button className="font-header p-2 px-6  text-lg rounded-md  bg-emerald-200">s'inscrire</button></Link>
          </div>
      </div>
      </header>
    )
